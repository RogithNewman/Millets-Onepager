    ...
    <section id="home" className="hero shell">
      ...
      <div className="hero-grid">
        ...
        <div className="hero-stage reveal in">
          ...
          <div className="hero-badge b2"><Icon.Leaf style={{ width: 18, height: 18, color: '#4a5d2a' }} />  freshly prepared </div>
          <div className="hero-badge b3"><Icon.Clock style={{ width: 18, height: 18, color: '#c84e1a' }} /> Delivered within 48 hours</div>
        </div>
      </div>
    </section>
  );
  ...
  return (
    <div className="hero-marquee-strip">
      <div className="marquee-track">
        <span className="marquee-pill"><Icon.Clock /> Orders freshly prepared & delivered within <strong>48 hours</strong></span>
        <span className="marquee-dot">✦</span>
        <span className="marquee-pill"><Icon.Leaf /> 100% Natural Ingredients</span>
        <span className="marquee-dot">✦</span>
        <span className="marquee-pill"><Icon.Heart /> Handmade with Love</span>
        <span className="marquee-dot">✦</span>
        <span className="marquee-pill"><Icon.Shield /> Hygiene Certified</span>
        <span className="marquee-dot">✦</span>
        <span className="marquee-pill"><Icon.Flame /> Fresh to Order</span>
        <span className="marquee-dot">✦</span>
